...
public class WebServer {
	 ...
	 * @throws Exception
	 */
	public WebServer( Road road ) throws Exception {
		this.road = road ;
		...
		contexts.setHandlers(new Handler[] { getBrainHandler(), getBrainDataHandler() } );
	...
	private Handler getBrainHandler() {
		...
		context.setHandler( new GameHandler( road ) ) ;        
		return context  ;
	}
	...
	public static class BrainDataServlet extends WebSocketServlet {		 
		...
		public void configure(WebSocketServletFactory factory) {
			factory.register(GameDataWebSocket.class);
		}
	}
	...
	private Handler getBrainDataHandler() {
		...
		final WebSocketCreator webSocketcreator = new WebSocketCreator() {
			public Object createWebSocket(ServletUpgradeRequest request,
				...
				return new GameDataWebSocket( road );
			}
		};
